...
//Todos retornan la posicion contando desde el valor 0, y si es que no se encuentra el valor de -1,
// ademas trabajan buscando en arreglos.

//Busqueda con datos ordenaods
//Busqueda Binaria
...
//Busqueda con datos no ordenaods
//Busqueda lineal
...
int main(int argc, char *name_file[]){
    ...
    writeArray("DatosO_InsertionSort.txt", array, num_elements);
    free(array);
